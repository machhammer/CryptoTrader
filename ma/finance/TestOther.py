...
date_2_months_back = (dt.date.today() - dt.timedelta(days=50)).strftime('%Y-%m-%d')
...
date_now = dt.datetime(now.year, now.month, now.day, now.hour, minute)
date_tomorrow = date_now + dt.timedelta(minutes=30)
date_after_tomorrow = date_now + dt.timedelta(minutes=60)
